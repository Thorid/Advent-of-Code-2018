    ...
    for cart,v in cartsPositions.items():
        ...
        if cartsDirections[cart] == '^':
            if (x,y-1) in newPositions.values():
                del newPositions[findKey(newPositions, (x,y-1))]
            elif (x,y-1) in cartsPositions.values():
                toCrash = findKey(cartsPositions, (x,y-1))
            else:
            ...
            if (x-1,y) in newPositions.values():
                del newPositions[findKey(newPositions, (x-1,y))]
            elif (x-1,y) in cartsPositions.values():
                toCrash = findKey(cartsPositions, (x-1,y))
            else:
            ...
            if (x+1,y) in newPositions.values():
                ...
                if railsMap[(x+1,y)] == '-':
                    ...
                    if cartXroads[cart] == 'L':
                        ...
                        newDirections[cart] = 'v'
                    cartXroads[cart] = changeXroadsDirection(cartXroads[cart])
    if toCrash != '' and toCrash in newPositions.keys():
        del newPositions[toCrash]
